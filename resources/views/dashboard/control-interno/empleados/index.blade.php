...
<div class="card content_d">
    <div class="card-body">
        ...
        <a class="btn btn-success mt-3 mb-3" href="{{ route('empleados.create') }}">
            Nuevo empleado
        </a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="formDelete" method="POST" action="{{ route('empleados.destroy',0) }}" 
                    data-action="{{ route('empleados.destroy',0) }}">
                    @method('DELETE')
                    @csrf
